...
(* OASIS_START *)
(* DO NOT EDIT (digest: 689b71b2da645824e0f86ed26cc449ed) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A framework for testing Xen Server";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "powercycle.ml"});
               Executable
                 ({
                     cs_name = "quicktest";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "K\199?\235U\241\027\199E\144\135A\247\197\223b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
